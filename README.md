...
> Inkl. [Netzwerkgeräte/Firewalls (pfSense)](./02-Exploitation/Network-Devices/pfsense.md).
...
> Inkl. [Firewall-Pivot/Route](./04-Post-Exploitation/Pivoting/firewall-pivot-und-route.md) und [PCAP/Forensik-Loot](./04-Post-Exploitation/Loot-Sources/pcap-und-forensik-artefakte.md).
...
> Reverse-Shell-Cheats, Encoding, Wordlists, msfvenom, AV-Evasion, Steganografie, schnelle Referenzen.
...
| nmap zeigt Port 445 + Win7/2008 | [EternalBlue MS17-010](./02-Exploitation/Windows/eternalblue-ms17-010.md) |
| ungewöhnlicher Port (1337) / XZ-Version | [XZ & Backdoor-Ports](./02-Exploitation/Linux/xz-backdoor-und-exposed-backdoors.md) |
| OS = Windows | [Windows Enum](./01-Exploration/Windows/README.md) |
| OS = Linux | [Linux Enum](./01-Exploration/Linux/README.md) |
| Web-Eingabefeld führt Befehle aus (Windows) | [Windows Command Injection](./02-Exploitation/Windows/command-injection-windows.md) |
| pfSense / Firewall trennt zwei Subnetze | [pfSense-Missbrauch](./02-Exploitation/Network-Devices/pfsense.md) · [Firewall-Pivot](./04-Post-Exploitation/Pivoting/firewall-pivot-und-route.md) |
| dual-homed Host → zweites Subnetz | [Pivoting (Chisel/SOCKS)](./04-Post-Exploitation/Pivoting/README.md) |
| Defender blockt deine EXE | [AV-Evasion](./99-Resources/av-evasion.md) |
