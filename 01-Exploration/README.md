...
> **🎯 Prüfung:** Kein UDP nötig — `nmap -p- -T5 $RHOST` genügt vollständig. Danach erst
> mit Versions-/Script-Scan auf die offenen Ports nachsetzen und **gezielt** entscheiden,
> statt sich sofort in einem Exploit zu verlieren.
>
> ```bash
> nmap -p- -T5 $RHOST -oN nmap_all.txt
> nmap -sV -sC -p <gefundene-ports> $RHOST -oN nmap_detail.txt
> ```
