...
>
> **🎯 Prüfung:** Der Prof nennt **Port 445 *und* 137** ausdrücklich — beide deuten auf SMB
> (445 = SMB direkt, 137 = NetBIOS-Name-Service). SMB liegt auf der **Windows**-Maschine.
> **Wichtig:** Ein Share muss **kein** Exploit sein — oft liegen dort einfach **Dateien/Infos**
> (Backups, Notizen, `.kdbx`, SAM-Kopien), die den nächsten Schritt liefern. Also immer
> Shares listen *und* deren Inhalt ziehen.
