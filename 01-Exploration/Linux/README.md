...
| 1337, 31337 | Backdoor? | unauthentifizierte Shell-Listener prüfen |
...
# Ungewoehnlicher Port mit offener Shell?
nc -nv $RHOST 1337           # -> evtl. unauthentifizierte RCE
```
→ Exponierte Backdoor-Ports / Supply-Chain (XZ): [xz-backdoor-und-exposed-backdoors.md](../../02-Exploitation/Linux/xz-backdoor-und-exposed-backdoors.md)
