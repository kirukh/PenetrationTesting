...
>
> **🎯 Prüfung:** Der **DemoCorp-Bericht (IPT-001)** kommt dran. Die exakt erwartete Gliederung
> (Ansprechpartner, Scope, Executive Summary, Risk-Faktoren, Walkthrough, Findings **pro VM**
> mit Risk-Begründung + PoC + Referenzen + betroffene Systeme, Remediation, Action-Plan) steht in
> **[democorp-report.md](./democorp-report.md)**.
